...
class Text:
    ...
    def __init__(self,x:int,y:int,text:str,size:int,font_name:Union[str,None]=None,bold:bool=False,italic:bool=False,underline:bool=False,antialias:bool=False,color:Any="black",background_color:Any=None):
