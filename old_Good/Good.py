...
class Point(Good):
    ...
    def draw(self,surface:Union[pygame.surface.Surface,None]=None)->None:
        ...
        self.rect=pygame.draw.circle(
            Good.surface if surface is None else surface,
...
def draw_goods(goods:List[Good],surface:Union[pygame.surface.Surface,None]=None)->List[pygame.Rect]:
    rects=[]
    for good in goods:
...
def draw_goods_and_update(goods:List[Good],surface:Union[pygame.surface.Surface,None]=None)->None:
    rects=[]
    for good in goods:
        if good.rect is not None: rects.append(good.rect)
        good.draw(surface)
